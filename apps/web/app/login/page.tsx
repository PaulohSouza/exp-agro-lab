        ...
        {modo === "login" ? (
          ...
          <form onSubmit={registrar}>
            <Campo label="Instituição">
              <input
                style={inp}
                value={reg.instituicaoNome}
                onChange={(e) => setReg({ ...reg, instituicaoNome: e.target.value })}
              />
            </Campo>
            <Campo label="Seu nome">
              <input
                style={inp}
                value={reg.adminNome}
                onChange={(e) => setReg({ ...reg, adminNome: e.target.value })}
              />
            </Campo>
            <Campo label="E-mail">
              <input
            ...
            <Campo label="Senha">
              <input
                style={inp}
                value={reg.adminSenha}
                onChange={(e) => setReg({ ...reg, adminSenha: e.target.value })}
                type="password"
              />
            </Campo>
            <button type="submit" disabled={busy} style={btn}>
