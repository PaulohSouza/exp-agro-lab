        ...
        <table style={{ width: "100%", minWidth: 720, borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>
            ...
            {(t.produtos ?? []).length === 0 && (
              <tr>
                <td style={cell} colSpan={9}>
                  <span style={{ color: "#a9abbd" }}>Sem produtos.</span>
                </td>
              </tr>
            )}
            ...
            <tr style={{ borderTop: "1px solid #e1e1ef" }}>
              ...
              <td style={cell}>
                <input
                  value={form.modoAplicacao}
                  onChange={(e) => setForm({ ...form, modoAplicacao: e.target.value })}
                  style={inp}
                />
              </td>
              <td style={cell}>
                ...
                />
                <input
                  value={form.unidadeDose}
                  onChange={(e) => setForm({ ...form, unidadeDose: e.target.value })}
                  style={{ ...inp, width: 56 }}
                />
              </td>
              <td style={cell}>
                <input
                  value={form.volumeCaldaLha}
                  onChange={(e) => setForm({ ...form, volumeCaldaLha: e.target.value })}
                  style={{ ...inp, width: 64 }}
                />
              </td>
              <td style={cell}>
              ...
              <td style={cell}>
                <select
                  value={form.timingId}
                  onChange={(e) => setForm({ ...form, timingId: e.target.value })}
                  style={inp}
                >
                  <option value="">—</option>
                  {timings.map((tm) => (
              ...
              <td style={cell}>
                <button onClick={adicionar} style={addBtn}>
                  adicionar
                </button>
              </td>
            </tr>
